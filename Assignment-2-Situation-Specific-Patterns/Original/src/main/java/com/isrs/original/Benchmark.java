...
/**
 * Benchmarking harness for the baseline ISRS implementation.
...
public class Benchmark {
    ...
    private static void runScenario() {
        ...
        database.addReviewer(new Reviewer("R001", "Dr. Smith", "AI", 2, false));
        database.addReviewer(new Reviewer("R002", "Dr. Johnson", "ML", 1, false));
        database.addReviewer(new Reviewer("R003", "Dr. Williams", "DS", 4, false));
        database.addReviewer(new Reviewer("R004", "Dr. Brown", "NLP", 0, true));
        database.addReviewer(new Reviewer("R005", "Dr. Davis", "CV", 6, false));
